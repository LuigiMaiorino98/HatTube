package LogicTier.GestioneCappelli.CatalogoBaseball;
...
@WebServlet(value ="/CatalogoBaseballServlet")
public class CatalogoBaseballServlet extends HttpServlet {

    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        Cappelli_Service cappelliService = new Cappelli_Service();
        ArrayList<Cappello> cappelli = cappelliService.recuperaCategoria("baseball");
