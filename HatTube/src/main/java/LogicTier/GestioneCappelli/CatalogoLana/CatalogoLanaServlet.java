package LogicTier.GestioneCappelli.CatalogoLana;
...
@WebServlet(value ="/CatalogoLanaServlet")

public class CatalogoLanaServlet extends HttpServlet {

    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        Cappelli_Service cappelliService = new Cappelli_Service();
        ArrayList<Cappello> cappelli = cappelliService.recuperaCategoria("lana");
